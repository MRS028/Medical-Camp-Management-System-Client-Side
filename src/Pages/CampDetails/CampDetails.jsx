...
const CampDetails = () => {
  ...
  const camp = camps.find((camp) => camp._id === CampId.id);
  ...
  return (
    ...
    <h1 className="text-2xl sm:text-3xl font-bold text-center mb-4 sm:mb-6">{camp.name}</h1>
    ...
    <div className="card bg-base-100 shadow-xl border border-gray-200 p-4">
      ...
      <div className="p-4 sm:p-6 space-y-4">
        <p className="text-sm sm:text-lg font-semibold flex items-center">
          ...
          Fees: <span className="font-normal ml-1">${camp.fees || "Free"}</span>
        </p>
        <p className="text-sm sm:text-lg font-semibold flex items-center">
          <FaCalendarAlt className="mr-2 text-blue-500" />
          Date & Time: <span className="font-normal ml-1">{camp.dateTime}</span>
        </p>
        <p className="text-sm sm:text-lg font-semibold flex items-center">
        ...
        <div className="text-center">
          <button className="btn btn-ghost text-white bg-gradient-to-r from-teal-500 to-green-400 btn-md sm:btn-lg">
            Join Camp
          </button>
        </div>
      </div>
